...
set.seed(7777)
init.analysis.3.prob = CMMFrequency(Y.freq.prob[, 2], X, 3)

set.seed(7777)
init.analysis.4.prob = CMMFrequency(Y.freq.prob[, 2], X, 4)

set.seed(7777)
init.analysis.5.prob = CMMFrequency(Y.freq.prob[, 2], X, 5)

set.seed(7777)
init.analysis.6.prob = CMMFrequency(Y.freq.prob[, 2], X, 6)
```
...
# 
# set.seed(7777)
# init.analysis.3.count = CMMFrequency(Y.freq.count[, 2], X.count, 3)
# 
# set.seed(7777)
# init.analysis.4.count = CMMFrequency(Y.freq.count[, 2], X.count, 4)
# 
# set.seed(7777)
# init.analysis.5.count = CMMFrequency(Y.freq.count[, 2], X.count, 5)
# 
# set.seed(7777)
# init.analysis.6.count = CMMFrequency(Y.freq.count[, 2], X.count, 6)
```
